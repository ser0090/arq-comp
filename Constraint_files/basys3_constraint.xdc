...
#
#set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { i_clk }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
set_property PACKAGE_PIN B18 [get_ports out_tx_uart]						
	set_property IOSTANDARD LVCMOS33 [get_ports out_tx_uart]
set_property PACKAGE_PIN A18 [get_ports in_rx_uart]						
