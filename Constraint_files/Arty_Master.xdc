...
## Clock signal
##pakage pin e3 selecciona el pin    -- tipo de tension que va a uilizar (lvcmos33=3.3v)
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clk100 }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]

##  le doy un nombre al clock para poder usarlo despues, ancho de reloj 10 perido, y la forma de onda cuadrada una en un estado y la otra en otra
## 
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { clk100 }];

##Switches
##se setea el pitn la tension  -------------------------------el puerto asociado al bit
...
## tambien se puede dar primero sete el pin despues la tension
##RGB LEDs
...
##Buttons estan al lado de los switchs
