...
def print_help():
    ...
    print('decode   get decode stage status')
    print('exec     get exec stage status')
    print('mem      get mem stage status')
    print('mem_data get data from data mem. it is not completly implemented yet.')
    print()
...
commands['mem_data']= lambda: cu.mem_data_req(ser,0,10)
